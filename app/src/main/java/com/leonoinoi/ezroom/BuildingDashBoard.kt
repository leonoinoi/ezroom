...
import kotlinx.android.synthetic.main.activity_building_dash_board.*

class BuildingDashBoard : AppCompatActivity() {

    private val list = ArrayList<Building>()
    private lateinit var myAdapter: MyAdapter
    private var selected = -1

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_building_dash_board)
        ...
        edit.setOnClickListener {
            if (selected == -1) {
                startActivity(Intent(this, BuildingEdit::class.java)
                        .putExtra("command", "create"))
            } else {
                startActivity(Intent(this, BuildingEdit::class.java)
                        .putExtra("command", "edit")
                        .putExtra("building", list[selected]))
            }
        }
            ...
            if (selected == -1) {
                ...
                AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(getString(R.string.button_delete), { _, _ ->
                            val ref = "/${FirebaseAuth.getInstance().currentUser!!.uid}/BUILDING/${list[selected].name}"
    ...
    inner class Listener : ValueEventListener {
        ...
        override fun onDataChange(data: DataSnapshot?) {
            ...
            list.clear()
            data.children.mapTo(list) { it.getValue(Building::class.java)!! }
    ...
    inner class MyAdapter : RecyclerView.Adapter<ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, type: Int): ViewHolder {
            this.parent = parent
            return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.list_building, parent, false))
        }
